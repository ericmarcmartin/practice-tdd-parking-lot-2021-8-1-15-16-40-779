...
class SuperSmartParkingBoyTest {
    ...
    @Test
    public void should_return_parked_car_when_fetch_the_car_given_parking_lot_with_parked_car_and_super_smart_parking_boy_and_ticket() {
        //given
        ParkingLot parkingLot = new ParkingLot();
        SuperSmartParkingBoy superSmartParkingBoy = new SuperSmartParkingBoy(parkingLot);
        Car car = new Car();
    ...
    @Test
    public void should_return_right_car_with_each_ticket_when_fetch_the_car_twice_given_parking_lot_with_2_parked_cars_and_super_smart_parking_boy_and_2_tickets() {
        //given
        ParkingLot parkingLot = new ParkingLot();
        SuperSmartParkingBoy superSmartParkingBoy = new SuperSmartParkingBoy(parkingLot);
    ...
    @Test
    public void should_return_nothing_with_error_message_when_fetch_the_car_given_parking_lot_and_super_smart_parking_boy_and_wrong_parking_ticket() {
        //given
        ParkingLot parkingLot = new ParkingLot();
        SuperSmartParkingBoy superSmartParkingBoy = new SuperSmartParkingBoy(parkingLot);
    ...
    @Test
    public void should_return_nothing_with_error_message_when_fetch_the_car_given_parking_lot_and_super_smart_parking_boy_and_used_parking_ticket() {
        //given
        ParkingLot parkingLot = new ParkingLot();
        SuperSmartParkingBoy superSmartParkingBoy = new SuperSmartParkingBoy(parkingLot);
        Car car = new Car();
    ...
    @Test
    public void should_return_nothing_with_error_message_when_park_the_car_given_parking_lot_without_any_position_and_super_smart_parking_boy_and_car() {
        //given
    ...
    @Test
    public void should_return_car_from_parking_1_when_park_the_car_given_super_smart_parking_boy_with_2_available_parking_lots_and_car() {
        //given
    ...
    @Test
    public void should_return_car_from_parking_lot_1_when_park_the_car_given_super_smart_parking_boy_where_parking_lot_1_has_larger_available_position_rate_and_car() {
        //given
        Car car = new Car();
        List<ParkingLot> parkingLotList = Arrays.asList(
                new ParkingLot(5),
    ...
    @Test
    public void should_return_car_from_parking_lot_2_when_park_the_car_given_super_smart_parking_boy_where_parking_lot_2_has_larger_available_position_rate_and_car() {
        //given
        Car car = new Car();
        List<ParkingLot> parkingLotList = Arrays.asList(
                new ParkingLot(2),
    ...
    @Test
    public void should_return_right_car_with_each_ticket_when_fetch_the_car_twice_given_super_smart_parking_boy_with_2_parking_lot_both_with_parked_car_and_2_tickets() {
        //given
        List<ParkingLot> parkingLotList = Arrays.asList(
                new ParkingLot(5),
                new ParkingLot(5)
    ...
    @Test
    public void should_return_nothing_with_error_message_when_fetch_the_car_given_super_smart_parking_boy_with_2_parking_lots_and_used_ticket() {
        //given
        List<ParkingLot> parkingLotList = Arrays.asList(
                new ParkingLot(2),
                new ParkingLot(2)
